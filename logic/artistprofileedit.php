...
if (isset($_POST["username"])) {
    ...
    foreach ($_FILES as $file) {
        ...
        $dbtarget_file = "https://artist.mwonyaa.com/assets/images/artistprofiles/" . $file['name'];
        ...
        if (move_uploaded_file($file['tmp_name'], $target_file)) {
            ...
            $query = mysqli_query($con, "UPDATE  artists SET profilephoto='$dbtarget_file' WHERE id='$selectartist'");
