...
<div class="create_media_container">
    ...
    <div class="mediaCreationheading" style="text-align: center;">
        <h5>Podcast</h5>
        <p style="font-size: 0.7em;color: #8b7097;">Create & Manage Podcast </p>
    ...
    <div class="statistics">
                    <div onclick="openPage('uploadcollection?tag=podcast')" class="card" style="background: #560083; color: #fff;">
                        <div class="illustration">
                            <img src="images/fluent_data-treemap-20-filled.svg" alt="">
                        </div>
                        <div class="stats">
                                <p class="label" style="color: #fff">New Podcast</p>
                        </div>

                    </div>
                    <div onclick="openPage('uploadmedia?tag=podcast')" class="card" style="background:#0d4e4e">
                        <div class="illustration">
                            <img src="images/fontisto_shopping-basket.svg" alt="">
                        </div>
                        <div class="stats">
                            <p class="label" style="color: #fff">Add New Podcast Episode</p>
                        </div>
                    </div>
