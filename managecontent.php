                    ...
                    <ul class="menu_nav-list">
                        ...
                        <li style="display:none;" class="menu_nav-item"><button class="menu_nav-button menu_nav-button--black"><i data-feather="file-plus"></i>Add<i data-feather="chevron-right"></i></button>
                            <ul class="menu_nav-sub-list">
                                <li class="menu_nav-item" onclick="openPage('singles')"><button class="menu_nav-button menu_nav-button--orange menu_nav-button--checked"><i data-feather="music"></i>Single<i data-feather="check"></i></button></li>
                                <li class="menu_nav-item" onclick="openPage('ep_page')"><button class="menu_nav-button menu_nav-button--green"><i data-feather="disc"></i>EP</button></li>
                                <li class="menu_nav-item" onclick="openPage('album')"><button class="menu_nav-button menu_nav-button--green"><i data-feather="folder"></i>Album</button></li>
                                <li class="menu_nav-item" onclick="openPage('podcast')"><button class="menu_nav-button menu_nav-button--green"><i data-feather="mic"></i>Podcast</button></li>
                                <li class="menu_nav-item" onclick="openPage('mixtape')"><button class="menu_nav-button menu_nav-button--green "><i data-feather="speaker"></i>Mix Tape</button></li>
                            </ul>
                        </li>
                        <li class="menu_nav-item" onclick="openPage('singles')"><button class="menu_nav-button"><i data-feather="music"></i>Single</button></li>
                        <li class="menu_nav-item" onclick="openPage('ep_page')"><button class="menu_nav-button"><i data-feather="disc"></i>EP</button></li>
                        <li class="menu_nav-item" onclick="openPage('album')"><button class="menu_nav-button"><i data-feather="folder"></i>Album</button></li>
                        <li class="menu_nav-item" onclick="openPage('podcast')"><button class="menu_nav-button"><i data-feather="mic"></i>Podcast</button></li>
            ...
            <div class="midddlesidedetails" id="albumSection">
                ...
                <div class="create_container ">
                    <div class="create_child_container">
                        <div class="activity" onclick="openPage('singles')">
                            <div class="icon">
                        ...
                        <div class="activity" onclick="openPage('ep_page')">
                            <div class="icon">
                                <svg width="50" height="50" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="activity" onclick="openPage('album')">
                        ...
                        <div class="activity" onclick="openPage('podcast')">
                        ...
                        <div class="activity" onclick="openPage('mixtape')">

                            <div class="icon">
                                <svg width="50" height="50" viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M39 39C36.4141 39 33.9342 40.0272 32.1057 41.8557C30.2772 43.6842 29.25 46.1641 29.25 48.75C29.25 51.3359 30.2772 53.8158 32.1057 55.6443C33.9342 57.4728 36.4141 58.5 39 58.5C41.5859 58.5 44.0658 57.4728 45.8943 55.6443C47.7228 53.8158 48.75 51.3359 48.75 48.75C48.75 46.1641 47.7228 43.6842 45.8943 41.8557C44.0658 40.0272 41.5859 39 39 39ZM39 65C34.6902 65 30.557 63.288 27.5095 60.2405C24.462 57.193 22.75 53.0598 22.75 48.75C22.75 44.4402 24.462 40.307 27.5095 37.2595C30.557 34.212 34.6902 32.5 39 32.5C43.3098 32.5 47.443 34.212 50.4905 37.2595C53.538 40.307 55.25 44.4402 55.25 48.75C55.25 53.0598 53.538 57.193 50.4905 60.2405C47.443 63.288 43.3098 65 39 65M39 13C40.7239 13 42.3772 13.6848 43.5962 14.9038C44.8152 16.1228 45.5 17.7761 45.5 19.5C45.5 21.2239 44.8152 22.8772 43.5962 24.0962C42.3772 25.3152 40.7239 26 39 26C37.2761 26 35.6228 25.3152 34.4038 24.0962C33.1848 22.8772 32.5 21.2239 32.5 19.5C32.5 15.8925 35.3925 13 39 13ZM55.25 6.5H22.75C19.1425 6.5 16.25 9.3925 16.25 13V65C16.25 66.7239 16.9348 68.3772 18.1538 69.5962C19.3728 70.8152 21.0261 71.5 22.75 71.5H55.25C56.9739 71.5 58.6272 70.8152 59.8462 69.5962C61.0652 68.3772 61.75 66.7239 61.75 65V13C61.75 11.2761 61.0652 9.62279 59.8462 8.40381C58.6272 7.18482 56.9739 6.5 55.25 6.5Z" fill="#F8F8F8" />
                                </svg>
