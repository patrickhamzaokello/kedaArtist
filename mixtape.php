...
<div class="create_media_container">
    ...
    <div class="mediaCreationheading" style="text-align: center;">
        <h5>Mixtape</h5>
        <p style="font-size: 0.7em;color: #8b7097;">Create & Manage Mixtape </p>
    ...
    <div class="statistics">
                    <div onclick="openPage('createcollection')" class="card" style="background: #560083; color: #fff;">
                        ...
                        <div class="stats">
                                <p class="label" style="color: #fff">New Mixtape</p>
                        </div>

                    </div>
                    <div onclick="openPage('uploadmedia?tag=dj')" class="card" style="background:#0d4e4e">
                        <div class="illustration">
                            <img src="images/fontisto_shopping-basket.svg" alt="">
                        </div>
                        <div class="stats">
                            <p class="label" style="color: #fff">Add Mixtape Tracks</p>
                        </div>
                    </div>
